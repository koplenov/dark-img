...
declare namespace $ {
	...
	type $mol_meta_description__content_dark_1 = $mol_type_enforce<
		ReturnType< $dark['seo_description'] >
		,
		ReturnType< $mol_meta_description['content'] >
	>
	type $mol_image__uri_dark_2 = $mol_type_enforce<
		ReturnType< $dark['avatar_src'] >
		,
		ReturnType< $mol_image['uri'] >
	>
	type $mol_image__natural_width_dark_3 = $mol_type_enforce<
		number
		,
		ReturnType< $mol_image['natural_width'] >
	>
	type $mol_image__natural_height_dark_4 = $mol_type_enforce<
		number
		,
		ReturnType< $mol_image['natural_height'] >
	>
	type $mol_paragraph__title_dark_5 = $mol_type_enforce<
		ReturnType< $dark['avatar_nickname'] >
		,
		ReturnType< $mol_paragraph['title'] >
	>
	type $mol_view__sub_dark_6 = $mol_type_enforce<
		readonly(any)[]
		,
		ReturnType< $mol_view['sub'] >
	>
	type $mol_card__status_dark_7 = $mol_type_enforce<
		string
		,
		ReturnType< $mol_card['status'] >
	>
	type $mol_card__content_dark_8 = $mol_type_enforce<
		readonly(any)[]
		,
		ReturnType< $mol_card['content'] >
	>
	type $mol_image__uri_dark_9 = $mol_type_enforce<
		ReturnType< $dark['img_src'] >
		,
		ReturnType< $mol_image['uri'] >
	>
	type $mol_image__natural_width_dark_10 = $mol_type_enforce<
		ReturnType< $dark['img_width'] >
		,
		ReturnType< $mol_image['natural_width'] >
	>
	type $mol_image__natural_height_dark_11 = $mol_type_enforce<
		ReturnType< $dark['img_height'] >
		,
		ReturnType< $mol_image['natural_height'] >
	>
	type $mol_image__minimal_width_dark_12 = $mol_type_enforce<
		number
		,
		ReturnType< $mol_image['minimal_width'] >
	>
	type $mol_image__minimal_height_dark_13 = $mol_type_enforce<
		number
		,
		ReturnType< $mol_image['minimal_height'] >
	>
	type $mol_card__status_dark_14 = $mol_type_enforce<
		string
		,
		ReturnType< $mol_card['status'] >
	>
	type $mol_card__content_dark_15 = $mol_type_enforce<
		readonly(any)[]
		,
		ReturnType< $mol_card['content'] >
	>

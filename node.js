...
;
	($.$dark) = class $dark extends ($.$mol_page) {
		seo_title(){
			return "";
		}
		Locales(){
		...
		created_by(){
			const obj = new this.$.$mol_view();
			(obj.sub) = () => ([(this.Avatar()), (this.Nickname())]);
			return obj;
		}
		UserCard(){
		...
		tools(){
			return [(this.Locales()), (this.Description())];
		}
		body(){
			return [
				(this.UserCard()), 
	...
	($mol_mem(($.$dark.prototype), "Locales"));
	($mol_mem(($.$dark.prototype), "Description"));
	($mol_mem(($.$dark.prototype), "Avatar"));
	($mol_mem(($.$dark.prototype), "Nickname"));
	($mol_mem(($.$dark.prototype), "created_by"));
	($mol_mem(($.$dark.prototype), "UserCard"));
	($mol_mem(($.$dark.prototype), "Picture"));
	($mol_mem(($.$dark.prototype), "DateCard"));
